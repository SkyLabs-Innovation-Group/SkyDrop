...
namespace SkyDrop.Droid.Helper
{
    ...
    public static class QRScannerHelper
    {
        ...
        {
            var width = DeviceDisplay.MainDisplayInfo.Orientation == DisplayOrientation.Portrait ? DeviceDisplay.MainDisplayInfo.Width : DeviceDisplay.MainDisplayInfo.Height;
            var height = DeviceDisplay.MainDisplayInfo.Orientation == DisplayOrientation.Portrait ? DeviceDisplay.MainDisplayInfo.Height : DeviceDisplay.MainDisplayInfo.Width;
            return GetScannerResolution(availableResolutions, width, height);
        }

        private static CameraResolution GetScannerResolution(List<CameraResolution> availableResolutions, double width, double height)
        {
